...
let test = "testsIsAstring"   // Variable Test Declared / (String value) Variable Assigned 
console.log("test")
...
const skills = [ "HTML" , "Javascrip" , "Python" , "C++" , " Ruby"]
...
const skills = [ "HTML" , "Javascrip" , "Python" , "C++" , "Ruby"] // list of skill to be added to array

console.log (skills.pop(4)) // removes the last object of the array
